...
Wayne <- Wayne %>%
  mutate(
    ...
    WhiteProportion    = White / sum(White),
    BlackProportion    = Black / sum(Black),
    AsianProportion    = Asian / sum(Asian),
    HispanicProportion = Hispanic / sum(Hispanic),
...
cartography::choroLayer(
  ...
  method = "quantile",
  nclass = 5,
  col = cartography::carto.pal(pal1 = "purple.pal", n1 = 5),
  legend.title.txt = "Share of County's White Population",
...
cartography::choroLayer(
  ...
  nclass = 5,
  col = cartography::carto.pal(pal1 = "purple.pal", n1 = 5),
  legend.title.txt = "Share of County's Black Population",
  legend.pos = "bottomright",
  border = "grey70"
)
cartography::layoutLayer(
...
cartography::choroLayer(
  ...
  nclass = 5,
  col = cartography::carto.pal(pal1 = "purple.pal", n1 = 5),
  legend.title.txt = "Share of County's Asian Population",
  legend.pos = "bottomright",
  border = "grey70"
)
cartography::layoutLayer(
...
cartography::choroLayer(
  ...
  nclass = 5,
  col = cartography::carto.pal(pal1 = "purple.pal", n1 = 5),
  legend.title.txt = "Share of County's Hispanic Population",
  legend.pos = "bottomright",
  border = "grey70"
)
cartography::layoutLayer(
